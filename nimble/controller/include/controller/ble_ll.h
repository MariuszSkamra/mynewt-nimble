...
#define BLE_LL_BIS_PHU_HDR_LLID(hdr) \
...
#define BLE_LL_BIS_LLID_IS_CTRL(hdr) \
    (BLE_LL_BIS_PHU_HDR_LLID(hdr) == BLE_LL_BIS_LLID_CTRL_PDU)
#define BLE_LL_BIS_LLID_IS_DATA(hdr) \
    ((BLE_LL_BIS_PHU_HDR_LLID(hdr) == BLE_LL_BIS_LLID_DATA_PDU_UNFRAMED_CMPLT) || \
     (BLE_LL_BIS_PHU_HDR_LLID(hdr) == BLE_LL_BIS_LLID_DATA_PDU_UNFRAMED_SC) || \
     (BLE_LL_BIS_PHU_HDR_LLID(hdr) == BLE_LL_BIS_LLID_DATA_PDU_FRAMED))
